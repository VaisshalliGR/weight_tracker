...
class DateTimeItem extends StatelessWidget {
  DateTimeItem({required Key key, required DateTime dateTime, required this.onChanged})
      : assert(onChanged != null),
        date = dateTime == null ? DateTime.now() : DateTime(dateTime.year, dateTime.month, dateTime.day),
        time = dateTime == null ? TimeOfDay.now() : TimeOfDay(hour: dateTime.hour, minute: dateTime.minute),
        super(key: key);
